<div class="page-wrapper" ng-app="LaporanApp" ng-controller="LaporanAppController">
    <div class="page-content">
        <!--breadcrumb-->
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Modul Laporan</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Data Laporan Transaksi Periode</li>
                    </ol>
                </nav>
            </div>
        ...
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">Informasi Laporan Pembayaran SPP</h6>
        <hr />
                ...
                <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="date" name="mulai_date" id="mulai_date" ng-model="tanggal_filter" placeholder="Tanggal Filter" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="date" name="end_date" id="end_date" ng-model="tanggal_filter" placeholder="Tanggal Filter" class="form-control">
